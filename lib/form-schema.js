...
/**
 * Did this submission accept the waiver?
 *
...
export function validate(body) {
  ...
  // The waiver is checked here, not just behind the "Proceed" button: the
  // recorded "Agreed" is only worth anything if a submission cannot arrive
  // without it.
  if (!agreedToWaiver(body)) {
